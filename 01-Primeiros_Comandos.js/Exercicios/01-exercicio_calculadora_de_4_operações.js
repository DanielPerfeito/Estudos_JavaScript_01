...
// Solicita ao usuário para inserir dois valores numéricos e converte-os para números de ponto flutuante
...
"A divisão de " + valor1 + " por " + valor2 + " é: " + div);

// Mensagem final exibida na tela com os resultados das operações.