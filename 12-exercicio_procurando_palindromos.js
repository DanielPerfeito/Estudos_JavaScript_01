...
if (palavra === palavraInvertida){
    alert("A palavra " + palavra + " é  um palindromo, sendo ela invertida, temos: " + palavraInvertida);
}
else{
alert("A palavra " + palavra + " não é um um palindromo, pois sua inversão não é igual a palava em sua forma original, sendo ela: " + palavraInvertida);
}
